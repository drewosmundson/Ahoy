...
// creates soundManager and configures for game
export function createSoundManager(camera) {
  const soundManager = new SoundManager(camera);
  soundManager.loadSoundEffect('mainTheme', 'resources/sounds/Lost_Sheep_Compressed.mp3');
  soundManager.loadSoundEffect('ambient', 'resources/sounds/waves.mp3');
  soundManager.playSound('mainTheme', 0.05);
  soundManager.playSound('ambient', 0.07);
  return soundManager
}
